...
function esAnagramaII(cadena1:string, cadena2:string):boolean {
    ...
    console.log(cadena1Final,"----",cadena2Final);
    // si cadena1Final y cadena2Final estan vacias, pero cadena1 y cadena2 eran distantas a vacias. 
    ...
    console.log(esAnagramaII("amor","roma"));